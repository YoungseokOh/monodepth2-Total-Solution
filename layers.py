...
class S1_ConvBlock(nn.Module):
    """Layer to perform a convolution followed by ELU
    """
    def __init__(self, in_channels, out_channels):
        super(S1_ConvBlock, self).__init__()
        self.pad = nn.ZeroPad2d(1)
        self.conv = nn.Conv2d(int(in_channels), int(out_channels), 5, 1, 2)
...
class S2_ConvBlock(nn.Module):
    """Layer to perform a convolution followed by ELU
    """
    def __init__(self, in_channels, out_channels):
        super(S2_ConvBlock, self).__init__()
        self.pad = nn.ZeroPad2d(1)
